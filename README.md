...
|---|---|---|
|Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.|**Ariana Huapaya**<br>TB1:xxxx<br><br>**Santiago Gordillo**<br>TB1:<br>xxxxxxx<br><br>**Sebastian Mendez**<br>TB1: <br>Expreso de manera clara y objetiva mis aportes y conclusiones sobre la arquitectura del software y el diseño de la experiencia de usuario, adaptando mi forma de comunicarme según el perfil técnico del público, dentro del desarrollo de un proyecto de ingeniería con equipos de distintas especialidades.<br><br>**Diego Pumahualcca**<br>TB1:<br>Comunico de manera clara, convincente y basada en evidencias los hallazgos del proyecto, adaptando su lenguaje y enfoque según el perfil del público. Utiliza datos reales, ejemplos contextualizados y recursos visuales para facilitar la comprensión, logrando que tanto equipos técnicos como stakeholders tomen decisiones informadas en el marco del desarrollo en ingeniería.<br><br>**Nicolas Vera**<br>TB1:<br>Durante el desarrollo de los entregables como el Impact Map, AS-IS Map, TO-BE Map y User Stories, comprendí la importancia de identificar y priorizar correctamente las necesidades de los futuros usuarios. Además, gracias a reuniones constantes con mis compañeros, fortalecí mi capacidad de comunicar ideas de manera clara para construir soluciones innovadoras y efectivas.|La comunicación oral ha sido efectiva dentro del equipo, permitiendo un intercambio fluido de ideas y una comprensión compartida de los objetivos del proyecto. Se continuará fomentando esta comunicación para mantener la colaboración y el progreso del trabajo.|
|Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería.|**Ariana Huapaya**<br>TB1:xxxxx<br><br>**Santiago Gordillo**<br>TB1:<br>xxxxxx<br><br>**Sebastian Mendez**<br>TB1:<br>Redacto con objetividad y claridad mis ideas y resultados relacionados con el desarrollo del proyecto de ingeniería, adecuando el nivel técnico de mi comunicación escrita según el perfil del público, ya sean especialistas o personas de otros niveles jerárquicos.<br><br>**Diego Pumahualcca**<br>TB1:<br>Redacto informes técnicos y ejecutivos con objetividad y claridad, adaptando el nivel de detalle y formato según el perfil del público. Transforma datos complejos en entregables comprensibles y visuales, facilitando la toma de decisiones informadas por parte de equipos interdisciplinarios y niveles jerárquicos diversos dentro del proyecto de ingeniería.<br><br>**Nicolas Vera**<br>TB1:<br>La elaboración de entregables como el Product Backlog, User Personas, Impact Map, y la estructura del Landing Page (Nav bar, Hero Section, Responsive, Animación y Botón de traducción) me permitió comunicar de forma escrita las ideas clave del proyecto. Gracias a este proceso de documentación, se logró mantener una línea clara de desarrollo, facilitando la comprensión de los entregables por parte de todos los miembros del equipo.|La comunicación escrita ha sido crucial para documentar el progreso del proyecto y asegurar la comprensión de los entregables entre los miembros del equipo. Se seguirá manteniendo un enfoque claro y conciso en la comunicación escrita para garantizar la eficacia y la calidad del trabajo.|
...
Usuario Persona que se une a NutriGain para ponerse en forma de una manera divertida, con entrenamientos que se adaptan a su vida y a sus intereses.

Camino Fitness Es el camino que el usuario elige al empezar su aventura en NutriGain: ¿quiere ganar músculo, ser más ágil como un atleta o encontrar equilibrio a través del yoga?

Personaje Virtual Es su compañero de viaje: un personaje que no solo anima, sino que también adapta los entrenamientos y la alimentación según cómo va progresando.

Rutina Semanal Es el plan de ejercicios de cada semana, personalizado y actualizado automáticamente para que siempre se ajuste a su nivel, ritmo de vida y metas.

Plan Nutricional Es una guía de comidas pensada para acompañar los entrenamientos, ayudando al usuario a alcanzar resultados de forma equilibrada y realista.

Desafíos Únicos Son mini-retos aleatorios y personalizados que aparecen para mantener la experiencia divertida, desafiante y diferente cada vez.

Reto Extremo Diario Es un desafío especial que cambia todos los días y lleva al usuario a superar sus propios límites, de forma intensa pero motivadora.

Gamificación Son los toques de juego que hacen a NutriGain especial: personajes, niveles, recompensas, desafíos… todo pensado para que entrenar sea algo que se disfrute, no una obligación.

Progreso del Usuario Es el seguimiento constante de cuánto ha mejorado: desde las metas cumplidas, hasta los desafíos ganados y los hábitos mantenidos.

Adaptabilidad Es la magia detrás de NutriGain: todo se ajusta solo —entrenamientos y alimentación— según el avance, los horarios y hasta los cambios de humor del usuario.

Entrenamiento en Casa/Gimnasio Es la libertad de decidir si hoy se entrena en la sala de su casa o en el gimnasio, sin perder calidad ni resultados.

Segmento Estudiante Son jóvenes universitarios que buscan mejorar su salud de manera divertida, fácil de integrar en su vida académica y accesible en cualquier momento.

Segmento Adulto Profesional Son adultos entre 30 y 40 años, trabajadores ocupados que quieren soluciones claras, prácticas y que realmente den resultados sin complicar su rutina diaria.
...
**Branding:**
Para empezar, desarrollamos el logo del producto, con los colores iniciales que tendrá la aplicación. Asimismo, adaptamos el branding para que sea flexible al ser colocado en cualquier espacio de la interfaz del usuario.

![Imagen de Branding](./assets/branding.png)

**Typography:**
En cuanto a la fuente de texto, utilizaremos dos tipografías de Google Fonts: Mulish y Rubik. La primera fuente será de uso general para los párrafos de texto, artículos y anotaciones. Por otro lado, emplearemos Rubik para títulos, subtítulos, encabezados y botones. La escala de cada una de estas fuentes variará de acuerdo a las reglas de estilos aplicadas para los diseños responsivos encontrados en la Landing Page y la aplicación web.

![Imagen de Tipografía](./assets/typography.png)

**Spacing System:**
Para el sistema de espaciados, mantendremos una cantidad de 5 píxeles de distancia entre un elemento y otro distribuido en la interfaz.

![Imagen de Espaciados](./assets/spacing.png)

**Colors:**
Como última guía de estilos, escogimos colores que podrían agregar dinamismo, energía y pasión por la ruta a escoger en la aplicación.

![Imagen de Colores](./assets/colors.png)

### 4.1.2. Web Style Guidelines

Como startup, establecimos algunos aspectos de estilo con los que contará nuestra landing page y la aplicación web.

-**Interfaz intuitiva y avatar de guía inicial:**
En el caso de la aplicación web, cada vista contará con una ruta de uso intuitiva y un avatar personalizable que te ayuda con la primer interacción con una vista nueva, a modo de tutorial. Mientras que, en la landing page, se utilizarán convenciones y una jerarquía clásica propia de las landing page.

-**Contraste de colores condicionales:**
Como se mencionó en la guía de estilos generales, la interfaz podría cambiar de color, de modo que uno de los colores secundarios seleccionados puede reemplazar al color primario. Por ende, este color condicional combinará con el tema que escoja el usuario (tema claro u oscuro).

-**Diseño minimalista e impecable:**
La aplicación web tendrá un diseño minimalista, de modo que la información sea concisa y no resulte tedioso al leer.
...
<title>NutriGain | El camino nutritivo definitivo</title>
<meta
  name="keywords"
  content="gimnasio,gym,nutrición,alimentación+saludable,gym+app,entrenamiento,yoga,deportes,vida+saludable,dieta,ejercicios"
/>
<meta
  name="description"
  content="Escoge un camino nutricional y SÉ TU MEJOR VERSIÓN. Organiza tu dieta y rutina de ejercicios entre MÁS DE 1000 COMBINACIONES POSIBLES."
/>
```
